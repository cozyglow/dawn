(function (window, k) {
    if (!window.AppstleIncluded && (!urlIsProductPage() || 'V1' === 'V2')) {
      ...
      appstleLoadScript("https://cdn.shopify.com/s/files/1/0920/5442/t/16/assets/appstle-subscription.js?v=1683985521");
      ...
      RS.Config = {
        ...
        "atcButtonSelector": "",
        "moneyFormat": "{% raw %}&pound;{{amount}}{% endraw %}",
        "oneTimePurchaseText": "One Time Purchase",
        "shop": "cozy-glow.myshopify.com",
